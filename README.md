...
> [Free Support](https://app-generator.dev/ticket/create/?generated_repo=https://github.com/app-generator/django-soft-1734411658) via `eMail` and `Discord`
...
```bash
$ git clone https://github.com/django-soft-1734411658.git
$ cd django-soft-1734411658
```
